...
public interface UserMapper {
    ...
    void UpDateUser(@Param("address") String address, @Param("birtherDay") Date birtherDay , @Param("sex") String sex, @Param("phoneNo") String phoneNo, @Param("academyName") String academyName, @Param("className") String className, @Param("userName") String userName);
